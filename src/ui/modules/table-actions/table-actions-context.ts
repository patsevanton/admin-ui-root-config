...
export const TableActionsStateContext =
  createContext<TableActionsState>(defaultState);
...
export function useTableActionsState(): TableActionsState {
  ...
  if (!context) {
    throw new Error(
      "useTableActionsState must be used within a TableActionsStateContext",
    );
  }
  return context;
}
...
export function useTableActionsDispatch(): Dispatch<Action> {
  ...
  if (!context) {
    throw new Error(
      "useTableActionsDispatch must be used within a TableActionsDispatchContext",
    );
  }
  return context;
}
